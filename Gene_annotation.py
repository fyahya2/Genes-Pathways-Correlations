...
def main():
    ...
    with open('/Users/farzaneh/Desktop/120Corr_T12.txt','r') as infile:
        for line in infile:
            with open("/Users/farzaneh/Desktop/Cell_Cycle.txt",'r') as infile2:
                for i, line2 in enumerate(infile2):
                    ...
                    if i == j:
                        #print(i)
                        with open('/Users/farzaneh/Desktop/T12_Cellgenes.txt', 'a') as outfile:
